package net.ays.onlineportal.service;
...
import net.ays.onlineportal.model.UserModel;
import net.ays.backendPortal.dao.CartLineDAO;
import net.ays.backendPortal.dao.ProductDAO;
import net.ays.backendPortal.dao.UserDAO;
import net.ays.backendPortal.dto.Cart;
import net.ays.backendPortal.dto.CartLine;
